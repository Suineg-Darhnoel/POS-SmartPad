...
\begin{frame}{Motivation}
    ...
    \end{itemize}
    \centering
    \visible<2->{\includegraphics[width=3cm]{first}}
    \visible<3->{\includegraphics[width=3cm]{second}}
    \visible<4->{\includegraphics[width=3cm]{third}}
\end{frame}
...
\begin{frame}{Interpolation}
    ...
    \visible<2->{\begin{block}{In case of Trigram}
        \begin{align*}
